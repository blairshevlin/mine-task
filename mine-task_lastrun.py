...
# Run 'Before Experiment' code from id_grab
subID = ''
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\blair\\Documents\\Research\\Sinai-K-Proj\\mine-task\\mine-task_lastrun.py',
